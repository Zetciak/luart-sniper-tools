...
const cacheRarity = require('./../../otherFunctions/cacheRarity/cacheRarity.js');

// >> Function
module.exports = {
	data: new SlashCommandBuilder()
		.setName('cacherarity')
		.setDescription('📛 Cache rarity into database (Owner)')
					...
					if (err) {
						...
						if (result.length > 0) {
							...
							const replyEmbed = new MessageEmbed()
								...
								.setDescription(
									`${collectionName} rarity cache in progress...`
								)
								.setTimestamp()
								.setFooter({
									text: interaction.member.user.username,
