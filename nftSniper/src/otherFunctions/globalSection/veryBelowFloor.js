...
function send(
	...
	let oblicz = collectionFloor - collectionFloor / 3;
	let obliczZarobas = collectionFloor - tokenLunaPrice;

	//Check mistake
	if (tokenLunaPrice <= oblicz) {
															...
															if (
																...
																const embed =
																	new MessageEmbed()
																		...
																		.addFields(
																			...
																			{
																				name: '⠀\n💵 Profit (Floor - token price)',
																				value: `\`${obliczZarobas.toFixed(
																					2
																				)}$LUNA (${(
																					obliczZarobas *
																					lunaPrice
																...
																if (
																	...
																	await sendChannel.send(
																		{
																			content: `<@&${process.env.veryBelowFloor}>\nhttps://marketplace.luart.io/collections/${collectionAddress}/${tokenId}`,
																			embeds: [
																				embed,
																			],
																		}
